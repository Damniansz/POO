            ...
            switch (opcion) {
                ...
                case 2:
                    ...
                    for (int i = 0; i < 6; i++) {
                        ...
                        alumnos[i] = new Alumno(cedula, nombre, direccion, telefono, celular, genero);
                    }
                ...
                case 3:
                    ...
                    for (int i = 0; i < 4; i++) {
                        ...
                        if(profesor != null){
                            ...
                            System.out.println("No se encontró un profesor con la cédula especificada. Intente nuevamente.");
                            i--;
